...
const AfterWove = () => {
  return (
    <div className='flex flex-col lg:flex-row '>
      <div className='flex flex-col lg:w-[406px] justify-center items-center lg:mt-44 lg:ml-7 lg:justify-start lg:items-start'>
        <div >
      ...
      <div className='flex flex-col md:mt-8  '>
        <div className='grid grid-cols-3 ml-10 md:mx-16 lg:ml-10 md:gap-24 lg:gap-44 mb-6 relative'>
          ...
          <div className='absolute max-w-[55.38px] top-8 left-[7.6rem] md:max-w-[80.38px] lg:max-w-[107.38px] md:top-16 md:left-[16.8rem] lg:top-16 lg:left-[21.8rem]'>
            <img src='./images/Straight2.svg' alt='' />
          </div>

          <div className='absolute max-w-[268px] top-8 left-4 md:max-w-[523.18px] lg:max-w-[900px] md:top-[3.9rem] md:left-12 lg:top-16 lg:left-8'>
        ...
        <div className='grid grid-cols-3 ml-10 md:mx-16 lg:ml-5  md:gap-24 lg:gap-44  mt-8 relative'>
          ...
          <div className='absolute max-w-[268px] -top-8 left-4  lg:max-w-[900px] md:max-w-[523.18px] md:top-[-5.1rem] md:left-12  lg:-top-28 lg:left-12'>
